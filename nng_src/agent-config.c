...
const char* logNames[] = { [NNG_LOG_NONE] = "LOG_NONE", [NNG_LOG_ERR]    = "LOG_ERR",
                           [NNG_LOG_WARN] = "LOG_WARN", [NNG_LOG_NOTICE] = "LOG_NOTICE",
                           [NNG_LOG_INFO] = "LOG_INFO", [NNG_LOG_DEBUG]   = "LOG_DEBUG"};
